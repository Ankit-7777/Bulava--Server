"""
Django settings for WeddingCard project.
...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-*c+awqyrp-yv@67*3_@qs^m#w@32*ua%p0jk*+yjl9-wx9v%1f')
...
MIDDLEWARE = [
    ...
    # 'WeddingApp.token_cookie_middleware.TokenBlacklistMiddleware',
